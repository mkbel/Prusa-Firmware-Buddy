...
static constexpr int _pwm_analogWrite_max = 256;
...
metric_t metric_nozzle_pwm = METRIC("nozzle_pwm", METRIC_VALUE_INTEGER, 1000, METRIC_HANDLER_DISABLE_ALL);
metric_t metric_bed_pwm = METRIC("bed_pwm", METRIC_VALUE_INTEGER, 1000, METRIC_HANDLER_DISABLE_ALL);
